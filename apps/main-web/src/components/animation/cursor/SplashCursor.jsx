...
function SplashCursor({
  ...
  // Mobile detection - if mobile, don't initialize at all
  ...
  useEffect(() => {
    ...
    const checkEnabled = () => {
      ...
      const currentOpacity = canvas.style.opacity
      if ((isEnabled && currentOpacity !== '1') || (!isEnabled && currentOpacity !== '0')) {
        console.log(`[SplashCursor] Changing opacity from ${currentOpacity} to ${isEnabled ? '1' : '0'}`)
      }
